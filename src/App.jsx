      ...
      >
        ...
        <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none">
          <div className="flex flex-col items-center gap-2 text-center p-4">
            ...
            <span className="text-sm uppercase tracking-widest font-bold text-white">Interactive Showcase</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div className="mb-20 md:mb-32 last:mb-0 w-full text-left">
    {(title || client || description) && (
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-6 md:mb-8 px-0">
        {client && (
          <span className="text-xs md:text-sm tracking-[0.4em] text-white/60 font-bold uppercase block mb-2">
            Client: {client}
          </span>
        )}
        {title && <h3 className="text-xl md:text-4xl font-black uppercase tracking-tighter mb-2 italic text-white">{title}</h3>}
        {description && <p className="text-base md:text-lg text-zinc-300 font-light leading-relaxed max-w-4xl">{description}</p>}
      </motion.div>
    )}
        ...
        {!isBelow && (
          <div className="absolute inset-0 p-6 md:p-12 lg:p-16 flex flex-col justify-between bg-gradient-to-b from-black/20 via-transparent to-black/90">
            <div className="flex justify-between items-start">
              <span className="text-xs md:text-sm tracking-[0.4em] text-white/60 font-bold uppercase">
                Client: {client}
              </span>
              {!noLink && (
                <motion.div
            ...
            <div>
              <p className="text-xs md:text-sm uppercase tracking-[0.3em] text-zinc-300 mb-2 font-medium">
                {category}
              </p>
      ...
      {isBelow && (
        <div className="p-6 md:p-10 bg-black flex flex-col gap-3 md:gap-4 border-t border-white/5 text-left flex-grow">
          <div className="flex justify-between items-center">
            <span className="text-xs md:text-sm tracking-[0.4em] text-white/50 font-bold uppercase">
              Client: {client}
            </span>
            {!noLink && <ArrowUpRight size={16} className="text-white/30" />}
          </div>
          <div>
            <p className="text-xs md:text-sm uppercase tracking-[0.3em] text-zinc-400 mb-1 font-bold">
              {category}
            </p>
...
const BannerSetStandard = ({ projectTitle, description, urls, billboardWidth = 970 }) => (
  <div className="mb-24 md:mb-48 last:mb-0 w-full px-0">
    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10 md:mb-16 text-left">
      ...
      <p className="text-lg md:text-xl text-zinc-300 font-light leading-relaxed max-w-4xl">{description}</p>
    </motion.div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[2px] bg-[#111] w-full border border-[#111]">
      <div className="flex flex-col items-center justify-start gap-[2px] w-full bg-[#050505]">
        <div className="flex flex-col items-center gap-4 w-full p-6 md:p-12">
          <span className="text-sm uppercase tracking-[0.3em] text-zinc-500 font-bold italic">300x250</span>
        ...
        <div className="flex flex-col items-center gap-4 w-full p-6 md:p-12 border-t border-[#111]">
          <span className="text-sm uppercase tracking-[0.3em] text-zinc-500 font-bold italic">728x90</span>
      ...
      <div className="flex flex-col items-center justify-center gap-4 w-full bg-[#050505] p-6 md:p-12 border-t md:border-t-0 md:border-l border-[#111]">
        <span className="text-sm uppercase tracking-[0.3em] text-zinc-500 font-bold italic">300x600</span>
      ...
      <div className="md:col-span-2 flex flex-col items-center gap-4 w-full bg-[#050505] py-10 md:py-24 border-t border-[#111]">
        <span className="text-sm uppercase tracking-[0.3em] text-zinc-500 font-bold italic">{billboardWidth}x250 Billboard</span>
    ...
    <div className="bg-[#050505] text-white min-h-screen selection:bg-white selection:text-black font-sans antialiased overflow-x-hidden">
      ...
      <nav className={`fixed top-0 w-full p-4 md:p-10 flex justify-between items-center z-50 transition-all duration-700 ${scrolled ? 'bg-black/95 backdrop-blur-xl py-4 md:py-5 border-b border-white/5' : 'bg-transparent'}`}>
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <h1 className="text-xs md:text-sm font-bold tracking-[0.3em] uppercase cursor-pointer">Clinton Doyle</h1>
        </div>
        <div className="hidden lg:flex space-x-12 text-sm uppercase tracking-[0.4em] font-bold">
        ...
        <div className="flex items-center gap-4 md:gap-6">
           <span className="hidden sm:block text-sm tracking-widest text-zinc-400 uppercase font-bold">Art Director & Motion</span>
      ...
      <section className="relative h-[90vh] md:h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 overflow-hidden">
        <div className="relative z-10 w-full">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-4 mb-6">
            <div className="h-[1px] w-8 md:w-12 bg-zinc-700" />
            <span className="text-sm uppercase tracking-[0.6em] text-zinc-400 font-bold italic">25+ Years Innovation</span>
          </motion.div>
        ...
        <div className="w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-32 items-start">
            ...
            <div className="space-y-20 md:space-y-32">
              <div className="text-left">
                <div className="mb-12 md:mb-16">
                  <h2 className="inline-block bg-white text-black text-xs md:text-sm uppercase tracking-[0.5em] font-black px-4 py-1.5 italic shadow-[4px_4px_0_rgba(255,255,255,0.1)]">Professional Experiences</h2>
                </div>
                ...
                <div className="space-y-8 md:space-y-10 group mb-16 md:mb-24">
                  <div className="flex items-center gap-4 md:gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm md:text-lg text-blue-500 font-black tracking-widest uppercase">Nation Creative | 2013 - 2024</p>
                    </div>
                  </div>
                  <div className="pl-4 border-l border-zinc-800 space-y-4 md:space-y-6">
                    <p className="text-zinc-300 text-lg md:text-xl leading-relaxed">
                      Led digital design across all campaigns, ensuring effective and impactful messaging.
                    </p>
                    <div>
                      <span className="text-xs uppercase tracking-widest text-zinc-500 font-bold block mb-3 md:mb-4">Core Clients:</span>
                      <div className="grid grid-cols-2 gap-x-4 md:gap-x-8 gap-y-1 text-zinc-400 text-sm font-medium italic">
                ...
                <div className="space-y-8 md:space-y-10 group mb-16 md:mb-24">
                  <div className="flex items-center gap-4 md:gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm md:text-lg text-blue-500 font-black tracking-widest uppercase">Imagination Games</p>
                    </div>
                  </div>
                  <div className="pl-4 border-l border-zinc-800 space-y-4 md:space-y-6">
                    <p className="text-zinc-300 text-lg md:text-xl leading-relaxed">
                      Drove graphic design efforts within product development, contributing to board games for global brands.
                    </p>
                    <div>
                      <span className="text-xs uppercase tracking-widest text-zinc-500 font-bold block mb-3 md:mb-4">Brand Partners:</span>
                      <div className="flex flex-wrap gap-x-4 md:gap-x-6 gap-y-1 text-zinc-400 text-sm font-medium italic uppercase tracking-tighter">
                ...
                <div className="space-y-8 md:space-y-10 group text-left">
                  <div className="flex items-center gap-4 md:gap-6">
                    ...
                    <div>
                      <h4 className="text-xl md:text-3xl font-bold uppercase italic text-white">Graphic Designer</h4>
                      <p className="text-sm md:text-lg text-blue-500 font-black tracking-widest uppercase text-wrap max-w-xs">Distillery, Via Media, Cinch Marketing</p>
                    </div>
                  </div>
                  <div className="pl-4 border-l border-zinc-800 space-y-4 md:space-y-6">
                    <p className="text-zinc-300 text-lg md:text-xl leading-relaxed">
                    ...
                    <div>
                      <span className="text-xs uppercase tracking-widest text-zinc-500 font-bold block mb-3 md:mb-4">Venue Clients:</span>
                      <div className="grid grid-cols-2 gap-1 text-zinc-400 text-sm font-medium italic">
            ...
            <div className="text-left mt-12 lg:mt-0">
              <div className="mb-12 md:mb-16">
                <h2 className="inline-block bg-white text-black text-xs md:text-sm uppercase tracking-[0.5em] font-black px-4 py-1.5 italic shadow-[4px_4px_0_rgba(255,255,255,0.1)]">Profile Summary</h2>
              </div>
              <div className="sticky top-24 md:top-32">
                ...
                <div className="space-y-6 md:space-y-8 text-base md:text-xl text-zinc-400 font-medium leading-relaxed max-w-2xl">
                  <p>
                ...
                <div className="mt-16 md:mt-20 pt-10 md:pt-16 border-t border-white/5">
                  <h5 className="text-sm md:text-base uppercase tracking-[0.4em] text-zinc-500 mb-8 md:mb-10 font-black italic">Core Skillset & Technical Proficiency</h5>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 md:gap-x-12 gap-y-4 md:gap-y-6">
                    {coreSkills.map((skill, index) => (
                      <div key={index} className="flex items-start gap-3 group">
                        ...
                        <span className="text-sm md:text-base text-zinc-300 font-bold italic uppercase tracking-widest leading-snug group-hover:text-white transition-colors">
                          {skill}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="mt-12 md:mt-16 pt-8 md:pt-12 border-t border-white/5">
                    <h5 className="text-sm md:text-base uppercase tracking-[0.4em] text-zinc-500 mb-4 md:mb-6 font-black">Location</h5>
                    <p className="text-sm md:text-base text-zinc-300 font-bold italic uppercase tracking-widest">
      ...
      <section id="art-direction" className="py-24 md:py-48 px-6 md:px-12 lg:px-24 bg-[#050505] border-b border-white/5">
        <div className="w-full">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 md:mb-16 text-left">
            <div className="mb-8">
              <h2 className="inline-block bg-white text-black text-xs md:text-sm uppercase tracking-[0.5em] font-black px-4 py-1.5 italic shadow-[4px_4px_0_rgba(255,255,255,0.1)]">Art Direction</h2>
            </div>
          </motion.div>
        ...
        <div className="w-full">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-20 md:mb-32 text-left">
            <div className="mb-6 md:mb-8">
              <h2 className="inline-block bg-white text-black text-xs md:text-sm uppercase tracking-[0.5em] font-black px-4 py-1.5 italic shadow-[4px_4px_0_rgba(255,255,255,0.1)]">Visuals & Interactive Production</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mt-16 md:mt-24">
             <div className="flex flex-col items-start space-y-4 md:space-y-6 text-left group cursor-pointer">
                ...
                <div>
                   ...
                   <p className="text-sm md:text-base text-zinc-400 leading-relaxed tracking-wider">Healthier choices Canberra ACT Government</p>
                </div>
             </div>
             ...
             <div className="flex flex-col items-start space-y-4 md:space-y-6 text-left group">
                ...
                <div>
                   <div className="mb-2">
                     <h4 className="inline-block bg-white text-black text-xs md:text-sm font-black uppercase italic px-3 py-1 tracking-widest">Broadcast Motion</h4>
                   </div>
                   <p className="text-sm md:text-base text-zinc-400 leading-relaxed tracking-wider font-bold">STI's Educational, ACT Health</p>
                </div>
             </div>
          </div>
          ...
          <div className="mt-24 md:mt-48 pt-12 md:pt-24 border-t border-white/5">
             <div className="flex flex-col items-start gap-8 md:gap-12">
                ...
                <VideoShowcase 
                  title=""
                  description=""
                  url="https://player.vimeo.com/video/273830129?badge=0&autopause=0&player_id=0&app_id=58479"
                />
             </div>
          </div>
        </div>
      ...
      <footer id="contact" className="py-16 md:py-24 px-6 md:px-12 lg:px-24 border-t border-white/5 bg-[#050505] text-left">
        <div className="flex flex-col items-start py-8 md:py-20">
          ...
          <div className="mt-8 flex flex-col md:flex-row md:items-center gap-4">
            <p className="text-zinc-500 tracking-[0.5em] uppercase text-sm md:text-base font-black">0417 822 283</p>
          </div>
        </div>
      </footer>
    </div>
